...
<?php include_once('includes/header.php');?>
    ...
    <body>
      ...
      <div class="container" >
        ...
        <center><h1> Real Estate Listings</h1><br></center>
        <td>
        <img src="images/images/real-estate.jpg"  width="410px"  height="350px"  alt="Service 3">
        </td>
        <td>

      <p>
        <strong><u><b>Real Estate Listings</b></u></strong><br>
        Real estate is real property that consists of land and improvements, which include buildings, fixtures, roads, structures, and utility systems. Property rights give a title of ownership to the land, improvements, and natural resources such as minerals, plants, animals, water, etc.<br>
        <h2><strong><u><b>What Is A Listing In Real Estate?</b></u></strong></h2>
A listing in real estate allows sellers to show their property is for sale in the real estate market. The information you see on the listing comes from the real estate listing terms agreed on by the owner and the agent authorized to handle the sale of the property.<br>

Sellers can choose among several methods to list a property. Pocket listings are rare and aren’t fully available to the public. For sale by owner <b>(FSBO) </b>keeps the buyer and seller from paying commissions but requires both parties to navigate through the complicated process of a home sale.<br>

Because other methods can be tricky, most sellers place their homes on their regional<b> multiple listing service (MLS).</b>
