...
<?php include_once('includes/header.php');?>
    ...
    <body>
      ...
      <div class="container" >
        ...
        <center><h1> Client Customized solutions</h1><br></center>
        <td>
        <img src="images/images/customized-solutions.jpg"  width="410px"  height="350px"  alt="Service 3">
        </td>
        <td>

      <p>
        <strong><u><b>What is entailed in cutomized solutions/ packages</b></u></strong><br>
        At Management Systems, a “customized solution” consists of the tools (one or more) selected to best meet client needs and how these tools are packaged and delivered within and to the client.
