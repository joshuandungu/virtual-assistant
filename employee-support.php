...
<?php include_once('includes/header.php');?>
    ...
    <body>
      ...
      <div class="container" >
        ...
        <center><h1> Employee  Onboarding  Support</h1><br></center>
        <td>
        <img src="images/images/employee-support.jpg"  width="410px"  height="350px"  alt="Service 3">
        </td>
        <td>

      <p>
        <strong><u><b>What is entailed in employee onboard support</b></u></strong><br>
