...
<?php include_once('header.php');?>
    ...
    <body>
      ...
      <div class="container" >
        ...
        <center><h1> Web Design & Development</h1><br></center>
        <td>
        <img src="images/images/web-design.jpg"  width="410px"  height="350px"  alt="Service 3">
        </td>
        <td>

      <p>
        <strong><u><b>What is entailed in web design ??</b></u></strong><br>
        ...
        <b>The are 4 types of web  development</b>
        <ol>
