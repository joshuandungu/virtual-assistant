...
<?php include_once('includes/header.php');?>
    ...
    <body>
      ...
      <div class="container" >
        ...
        <center><h1> Photoshop</h1><br></center>
        <td>
        <img src="images/images/photoshop.jpg"  width="410px"  height="350px"  alt="Service 3">
        </td>
        <td>

      <p>
        <strong><u><b>What are the 4 main purposes of photoshop</b></u></strong><br>



<b><strong>Adobe Photoshop</strong></b> is a critical tool for designers, web developers, graphic artists, photographers, and creative professionals. It is widely used for image editing, retouching, creating image compositions, website mockups, and adding affects. Digital or scanned images can be edited for use online or in-print.
