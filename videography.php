...
<?php include_once('header.php');?>
    ...
    <body>
      ...
      <div class="container" >
        ...
        <center><h1> Video editing $ videography</h1><br></center>
        <td>
        <img src="images/images/video-editing.jpg"  width="410px"  height="350px"  alt="Service 3">
        </td>
        <td>

      <p>
        <strong><u><b>Why do you need video editing skills</b></u></strong><br>
